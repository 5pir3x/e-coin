...
import static com.company.Constants.BLOCKCHAIN_DB_CONNECTION;
import static com.company.Constants.WALLET_DB_CONNECTION;
...
public class ECoin extends Application {
    ...
    public void init() {
        try {
            createWalletInDatabaseIfNoneExists();
            createBlockchainInDatabaseIfNoneExists();
     ...
     */
    private void createWalletInDatabaseIfNoneExists() throws SQLException, NoSuchAlgorithmException, InvalidKeySpecException {
        Connection walletConnection = DriverManager
                .getConnection(WALLET_DB_CONNECTION);
     ...
     */
    private void createBlockchainInDatabaseIfNoneExists() throws SQLException, GeneralSecurityException {
        Connection blockchainConnection = DriverManager
                .getConnection(BLOCKCHAIN_DB_CONNECTION);
