...
public class ECoin extends Application {
    ...
    public void init() {
        try {
            createWalletInDbIfNoneExists();
            createBlockchainInDbIfNoneExists();
    ...
    private static void createWalletInDbIfNoneExists() throws SQLException, NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    private static void createBlockchainInDbIfNoneExists() throws SQLException, GeneralSecurityException {
